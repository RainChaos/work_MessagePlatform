		 ...
		 return {
		    ...
		    ,cols: [[ //表头
              {type:'checkbox'}
				...
				,{field:'schname', title: '学校', sort: true,width:137}
              ...
              ,{field:'stuname', title: '学生姓名',width: 137}
				...
				,{field:'operatetime', title: '操作时间',width:180,templet: '<div>{{ formatTime(d.operatetime,"yyyy-MM-dd hh:mm:ss")}}</div>'}
		    ]]
				,page: true //开启分页
