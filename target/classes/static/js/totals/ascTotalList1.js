layui.config({
                    ...
                    tree.render({
                        ...
                        ,click: function(obj){
                            ...
                            if (obj.children==null) {
                                clCode = obj.id;
                                url="/page/getAscPieCountGroupByState?startDate="+startDate+"&endDate="+endDate+"&clCode="+obj.id;
                                url2="/page/getAscLineCountGroupByState?startDate="+startDate+"&endDate="+endDate+"&clCode="+obj.id;
                                pie(startDate,endDate,flag,url);
                                line(startDate,endDate,flag,url2);
                                $("#parentTitle").text(obj.name+"数据统计");
                            }
                        }
                    });
    ...
    var url="/page/getAscPieCountGroupByState"+"?clCode="+clCode;
