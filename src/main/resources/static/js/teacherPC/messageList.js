		    ...
		    ,cols: [[ //表头
              ...
              ,{field:'teNo', title: '发送者编号',width: 137}
				...
				// ,{field:'msgContent',title: '信息内容'}
				 ,{title: '详情',templet: '#msgContent'}
              ,{field:'msgType', title: '信息类型',width:100}
				// ,{title: '消息详情',templet: '#detailsTpl'}
				,{field:'remark', title: '说明'}
				,{field:'sendDate', title: '发送时间',templet: '<div>{{ formatTime(d.sendDate,"yyyy-MM-dd hh:mm:ss")}}</div>'}
				,{field:'createDate', title: '创建时间',templet: '<div>{{ formatTime(d.createDate,"yyyy-MM-dd hh:mm:ss")}}</div>'}
              ,{field:'state', title: '状态',width:100}
              ,{title: '操作',toolbar: '#barEdit',width:215}
		    ]]
				,page: true //开启分页
