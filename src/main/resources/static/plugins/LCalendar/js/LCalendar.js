    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function (type) {
            ...
            function finishMobileYM(e) {
                ...
                var oldText = _self.dom.text().split(':')[0];
                _self.dom.text(oldText + ":" + (date_yy % passY + _self.minY) + "-" + date_mm);
                //增加回调函数 modify by hcx
