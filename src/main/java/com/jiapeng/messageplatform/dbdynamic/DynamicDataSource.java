...
//            }
    ...
    public void createDataSourceWithCheck(SchoolDB dataSource) throws Exception {
        String datasourceId = dataSource.getScCode();
    ...
    private void createDataSource(SchoolDB dataSource) throws Exception {
        String datasourceId = dataSource.getScCode();
